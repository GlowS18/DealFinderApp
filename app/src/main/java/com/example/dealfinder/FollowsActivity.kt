...
import com.example.dealfinder.Post
import com.example.dealfinder.PostAdapter
        ...
        db.collection("follows")
            ...
            .addOnSuccessListener { documents ->
                for (document in documents) {
                    follows.add(document.data["id"].toString())
                }
                ...
                for(follow in follows) {
                    ...
                    docRef.get()
                        .addOnSuccessListener { doc ->
                            if (doc.exists()) {
                                posts.add(
                                    Post(doc.id, doc.data!!["uid"].toString(), doc.data!!["text"].toString(), doc.data!!["desc"].toString())
                                )
